<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Laravel 12</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <x-navbar-link href="/" :active="request()->is('/')">Home</x-navbar-link> <!-- Request is a helper function to help identify the page we are in now -->
                ...
                @endguest
                @auth
                    <span class="text-blue-500 dark:text-blue-400 fotnt-semibold">{{ Auth::user()->name }}</span>
