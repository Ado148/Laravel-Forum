<x-layout>
    <section class="mt-4">
        <div class="flex justify-end">
            <div class="flex justify-between">
                @can('update', $post) <!-- Check if the user can update the post -->
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-8 bg-slate-50 dark:bg-slate-700 rounded-lg">
        <h1 class="text-3xl text-indigo-600 font-semibold dark:text-indigo-400">{{ $post->title }}</h1>
        <main class="max-w-6xl max-auto mt-6 lg:mt-20 space-y-6">
            <p class="text-gray-700 p-4 mb-4 dark:text-white">{{ $post->content }}</p>
        </main>
    </div>
</x-layout>